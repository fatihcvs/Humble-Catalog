...
- `[recurred]` The leak gate can block vocabulary you cannot reword - a standard library class name tripped it once. Prefer an explicit test double over that class anyway; do NOT widen ALLOWED, which would blind the gate to real titles.
